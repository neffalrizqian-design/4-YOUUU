    ...
    <div class="card">
        ...
        <div class="page" id="page-video" style="display:none;">
            ...
            <div class="video-container">
                <video id="introVideo" controls autoplay playsinline preload="auto" volume="1.0" style="--volume: 1.0;">
    ...
    <script>
        (function() {
            ...
            if (video) {
                ...
                // Pastikan volume maksimum saat video dimuat
